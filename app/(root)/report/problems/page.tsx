...
import { reportProbColumns } from "@/constants";
...
const ReportProblems = () => {
  ...
  const baseUrl = `${process.env.NEXT_PUBLIC_API_URL}/user/instansi/reportmasalah`;
  ...
  const handleDownload = async () => {
    ...
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/user/instansi/pdf-reportmasalah?instansi_id=${instanceId2}&start_date=${startDateFormatted}&end_date=${endDateFormatted}`,
        {
          method: "GET",
          headers: {
      ...
      a.href = url;
      a.download = "laporan-permasalahan.pdf";
