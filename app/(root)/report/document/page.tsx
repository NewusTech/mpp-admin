...
import { reportDocColumns } from "@/constants";
...
const ReportDocument = () => {
  ...
  const baseUrl = `${process.env.NEXT_PUBLIC_API_URL}/user/instansi/reportdocterbit`;
  ...
  const handleDownload = async () => {
    ...
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/user/instansi/pdf-reportdocterbit?instansi_id=${instanceId2}&start_date=${startDateFormatted}&end_date=${endDateFormatted}`,
        {
          method: "GET",
          headers: {
      ...
      a.href = url;
      a.download = "laporan-dokumen-terbit.pdf";
