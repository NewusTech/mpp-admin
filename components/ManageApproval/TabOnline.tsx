  ...
  const handleDownload = async () => {
    ...
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/historyform/pdf?status=1&isonline=1&instansi_id=${instanceId}&start_date=${startDateFormatted}&end_date=${endDateFormatted}`,
        {
          method: "GET",
          headers: {
      ...
      a.href = url;
      a.download = "report permohonan online yang sudah divalidasi.pdf";
